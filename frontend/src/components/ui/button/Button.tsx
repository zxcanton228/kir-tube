...
export function Button({ children, variant = 'primary', isLoading, className, ...props }: Props) {
	return (
		<button
			role={props.role || 'button'}
			className={cn(twMerge('py-2 px-10 font-semibold rounded transition-colors disabled:bg-gray-400', className), {
