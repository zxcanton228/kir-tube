...
class UniqPages {
	...
	public readonly PLAYLISTS = (path?: string | number): string => `/my/playlists${path ? `/${path}` : ''}`
...
class PublicPage extends UniqPages {
	...
	public readonly SUBSCRIPTIONS: string = '/my/subscriptions'
	public readonly HISTORY: string = '/my/history'
	public readonly LIKED_VIDEOS: string = '/my/liked-videos'
