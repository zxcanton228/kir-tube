...
exports.CHANNELS = [
    {
        name: 'RED Group',
        slug: 'redgroup',
        description: 'htmllessons.io - Интенсивы #1 по веб разработке,  наша главная цель — подготовить профессионалов.',
    ...
    },
    {
        name: 'RED Group +',
        slug: 'redgroup-plus',
        description: 'Новый канал от RED Group. Здесь будут выходить расширенные материалы, более подробные и скучные гайды, а также 5-часовые практики больших проектов.',
    ...
    },
    {
        name: 'Maddix // EXTATIC',
        slug: 'maddixmusic',
        description: 'Dutch DJ/producer Maddix is known for his genre-breaking techno-rave sound, infused with big room and trance influences.',
    ...
    },
    {
        name: 'Maisy Leigh',
        slug: 'maisyleigh',
        description: 'Hi! I`m Maisy! Bringing cozy creations to life, finding my zen, and sharing my cozy lifestyle :)',
    ...
    },
    {
        name: 'SpawnPoiint',
        slug: 'spawnpoiint',
        description: 'SpawnPoiint: Weekly videos about Tech, Gaming and Setups! Bringing you high quality and aesthetically pleasing content from the UK. Reviewing the latest smart home tech, PlayStation, Xbox, TV Setups, Desk Setups, Apple, Gaming and more. Everything you see is recorded on an iPhone.',
    ...
    },
    {
        ...
        description: 'Relive all the magical moments of Tomorrowland all year long.',
        avatarUrl: '/uploads/avatars/tomorrow.jpg',
        bannerUrl: '/uploads/banners/tomorrowb.jpg',
        isVerified: true
    }
];
//# sourceMappingURL=channels.data.js.map